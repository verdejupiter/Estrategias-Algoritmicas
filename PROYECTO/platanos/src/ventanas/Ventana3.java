...
" Se RECOMIENDA acudir a los Distritos a FUMIGAR \ny evitar la propagación de la PLAGA.");
    ...
    private void initComponents() {
        ...
        getContentPane().add(area1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 140, 530, 390));
        ...
        getContentPane().add(p, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 630, 610));
